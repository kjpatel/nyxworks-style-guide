export const colors = {
  core: [
    { name: "bg", variable: "--color-bg", value: "#0a0a0f", usage: "Page background" },
    { name: "bg-card", variable: "--color-bg-card", value: "#13131a", usage: "Card / panel backgrounds" },
    { name: "bg-card-hover", variable: "--color-bg-card-hover", value: "#1a1a24", usage: "Card hover state" },
    { name: "border", variable: "--color-border", value: "#1e1e2e", usage: "Borders, dividers" },
    { name: "text-primary", variable: "--color-text-primary", value: "#e4e4e7", usage: "Headings, body text" },
    { name: "text-secondary", variable: "--color-text-secondary", value: "#a1a1aa", usage: "Descriptions, secondary text" },
    { name: "text-muted", variable: "--color-text-muted", value: "#71717a", usage: "Captions, placeholders" },
    { name: "accent", variable: "--color-accent", value: "#7c3aed", usage: "Primary brand color, buttons" },
    { name: "accent-light", variable: "--color-accent-light", value: "#a78bfa", usage: "Hover states, highlights" },
    { name: "accent-dark", variable: "--color-accent-dark", value: "#6d28d9", usage: "Active states, gradients" },
  ],
  semantic: [
