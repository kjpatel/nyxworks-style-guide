...
const sections = [
  ...
  {
    title: "Components",
    description: "63 reusable UI components with live previews and source code.",
    href: "/components",
    icon: Component,
  },
  {
  ...
  {
    title: "Examples",
    description: "15 full page layouts — dashboard, auth, CRUD, settings, onboarding, pricing, marketing, ecommerce, and more.",
    href: "/examples",
    icon: Layers,
  },
];
